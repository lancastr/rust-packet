...
impl<B: AsRef<[u8]>> Packet<B> {
    ...
    pub fn source(&self) -> Ipv4Addr {
        Ipv4Addr::new(self.buffer.as_ref()[12], self.buffer.as_ref()[13], self.buffer.as_ref()[14], self.buffer.as_ref()[15])
    }

    /// Destination IP address.
    pub fn destination(&self) -> Ipv4Addr {
        Ipv4Addr::new(self.buffer.as_ref()[16], self.buffer.as_ref()[17], self.buffer.as_ref()[18], self.buffer.as_ref()[19])
    }
